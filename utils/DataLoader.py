...
class Data:
    ...
    def print(self):    
        ...
        print(f'self.src_node_ids: {self.src_node_ids}')
        print(f'self.dst_node_ids: {self.dst_node_ids}')
        print(f'self.node_interact_times: {self.node_interact_times}')
        print(f'self.edge_ids: {self.edge_ids}')
