...
class ArgsParser(object):
    def __init__(self):
        ...
        # Required parameters
        parser.add_argument(
            "--timestamp", default=None, type=str, required=True, help="The timestamp to deal with."
        )          
        # Required parameters
        parser.add_argument(
            "--dataset", default=None, type=str, required=True, help="The datasest name."
        )        
        parser.add_argument(
